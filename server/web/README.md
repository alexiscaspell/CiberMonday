...
El `docker/Dockerfile.server` construye una imagen basada en Python con Flask y las dependencias necesarias.

## Solución de problemas

| Problema | Solución |
|----------|----------|
| Puerto 5000 en uso | Cambiar `PORT` en `.env` o `docker/docker-compose.yml` |
